...
.controller('ProductDetailCtrl', function($scope,$rootScope, $ionicModal, $timeout,$ionicPopover,$ionicSlideBoxDelegate,$stateParams,$location,$state,productsService,eCart,alertmsgService)
	{
